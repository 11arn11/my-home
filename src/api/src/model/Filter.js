...
import IngredientsIdFields from './IngredientsIdFields';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fields')) {
                obj['fields'] = IngredientsIdFields.constructFromObject(data['fields']);
            }
...
/**
 * @member {module:model/IngredientsIdFields} fields
 */
