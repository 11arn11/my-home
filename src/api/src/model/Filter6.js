...
import StoredItemsIdFields from './StoredItemsIdFields';
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('fields')) {
                obj['fields'] = StoredItemsIdFields.constructFromObject(data['fields']);
            }
...
/**
 * @member {module:model/StoredItemsIdFields} fields
 */
 ...
 */
Filter6.prototype['include'] = undefined;
