...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.StoredItemsIdFields();
  });
  ...
  describe('StoredItemsIdFields', function() {
    it('should create an instance of StoredItemsIdFields', function() {
      // uncomment below and update the code to test StoredItemsIdFields
      //var instane = new LoopBackApplication.StoredItemsIdFields();
      //expect(instance).to.be.a(LoopBackApplication.StoredItemsIdFields);
    });
