...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Filter5();
  });
  ...
  describe('Filter5', function() {
    it('should create an instance of Filter5', function() {
      // uncomment below and update the code to test Filter5
      //var instane = new LoopBackApplication.Filter5();
      //expect(instance).to.be.a(LoopBackApplication.Filter5);
    });
