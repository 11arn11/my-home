...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.RecipesIdFields();
  });
  ...
  describe('RecipesIdFields', function() {
    it('should create an instance of RecipesIdFields', function() {
      // uncomment below and update the code to test RecipesIdFields
      //var instane = new LoopBackApplication.RecipesIdFields();
      //expect(instance).to.be.a(LoopBackApplication.RecipesIdFields);
    });
