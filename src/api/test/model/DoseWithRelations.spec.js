...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.DoseWithRelations();
  });
  ...
  describe('DoseWithRelations', function() {
    it('should create an instance of DoseWithRelations', function() {
      // uncomment below and update the code to test DoseWithRelations
      //var instane = new LoopBackApplication.DoseWithRelations();
      //expect(instance).to.be.a(LoopBackApplication.DoseWithRelations);
    });
