...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Filter2();
  });
  ...
  describe('Filter2', function() {
    it('should create an instance of Filter2', function() {
      // uncomment below and update the code to test Filter2
      //var instane = new LoopBackApplication.Filter2();
      //expect(instance).to.be.a(LoopBackApplication.Filter2);
    });
