...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.LoopbackCount();
  });
  ...
  describe('LoopbackCount', function() {
    it('should create an instance of LoopbackCount', function() {
      ...
      //var instane = new LoopBackApplication.LoopbackCount();
      //expect(instance).to.be.a(LoopBackApplication.LoopbackCount);
    });
