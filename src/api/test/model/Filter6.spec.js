...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Filter6();
  });
  ...
  describe('Filter6', function() {
    it('should create an instance of Filter6', function() {
      // uncomment below and update the code to test Filter6
      //var instane = new LoopBackApplication.Filter6();
      //expect(instance).to.be.a(LoopBackApplication.Filter6);
    });
