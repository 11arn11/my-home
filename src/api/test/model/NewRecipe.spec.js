...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.NewRecipe();
  });
  ...
  describe('NewRecipe', function() {
    it('should create an instance of NewRecipe', function() {
      // uncomment below and update the code to test NewRecipe
      //var instane = new LoopBackApplication.NewRecipe();
      //expect(instance).to.be.a(LoopBackApplication.NewRecipe);
    });
