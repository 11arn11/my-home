...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.StoredItemWithRelations();
  });
  ...
  describe('StoredItemWithRelations', function() {
    it('should create an instance of StoredItemWithRelations', function() {
      // uncomment below and update the code to test StoredItemWithRelations
      //var instane = new LoopBackApplication.StoredItemWithRelations();
      //expect(instance).to.be.a(LoopBackApplication.StoredItemWithRelations);
    });
