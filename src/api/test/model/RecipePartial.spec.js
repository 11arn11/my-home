...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.RecipePartial();
  });
  ...
  describe('RecipePartial', function() {
    it('should create an instance of RecipePartial', function() {
      // uncomment below and update the code to test RecipePartial
      //var instane = new LoopBackApplication.RecipePartial();
      //expect(instance).to.be.a(LoopBackApplication.RecipePartial);
    });
