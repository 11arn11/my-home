...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.MealsIdScope();
  });
  ...
  describe('MealsIdScope', function() {
    it('should create an instance of MealsIdScope', function() {
      // uncomment below and update the code to test MealsIdScope
      //var instane = new LoopBackApplication.MealsIdScope();
      //expect(instance).to.be.a(LoopBackApplication.MealsIdScope);
    });
