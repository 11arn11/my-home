...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Filter7();
  });
  ...
  describe('Filter7', function() {
    it('should create an instance of Filter7', function() {
      // uncomment below and update the code to test Filter7
      //var instane = new LoopBackApplication.Filter7();
      //expect(instance).to.be.a(LoopBackApplication.Filter7);
    });
