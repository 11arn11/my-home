...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.NewDoseInRecipe();
  });
  ...
  describe('NewDoseInRecipe', function() {
    it('should create an instance of NewDoseInRecipe', function() {
      // uncomment below and update the code to test NewDoseInRecipe
      //var instane = new LoopBackApplication.NewDoseInRecipe();
      //expect(instance).to.be.a(LoopBackApplication.NewDoseInRecipe);
    });
