...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Filter3();
  });
  ...
  describe('Filter3', function() {
    it('should create an instance of Filter3', function() {
      // uncomment below and update the code to test Filter3
      //var instane = new LoopBackApplication.Filter3();
      //expect(instance).to.be.a(LoopBackApplication.Filter3);
    });
