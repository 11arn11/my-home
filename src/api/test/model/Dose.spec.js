...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.Dose();
  });
  ...
  describe('Dose', function() {
    it('should create an instance of Dose', function() {
      // uncomment below and update the code to test Dose
      //var instane = new LoopBackApplication.Dose();
      //expect(instance).to.be.a(LoopBackApplication.Dose);
    });
