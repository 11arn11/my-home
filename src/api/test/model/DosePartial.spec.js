...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LoopBackApplication.DosePartial();
  });
  ...
  describe('DosePartial', function() {
    it('should create an instance of DosePartial', function() {
      // uncomment below and update the code to test DosePartial
      //var instane = new LoopBackApplication.DosePartial();
      //expect(instance).to.be.a(LoopBackApplication.DosePartial);
    });
